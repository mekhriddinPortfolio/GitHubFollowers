...
//  GHFollowers
//
//  Created by dev ios on 01/05/22.
//
...
class FollowersListVC: GFDataLoadingVC {
    ...
    func configureDataSourse() {
        dataSourse = UICollectionViewDiffableDataSource<Section, Follower>(collectionView: collectionView, cellProvider: { collectionView, indexPath, follower in
            ...
            case .success(let user):
                ...
                PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
                    ...
                    guard let error = error else {
                        self.presentGFAlertOnMainThread(title: "Success!", message: "You have successfully favorited this use🎉", buttonTitle: "Hooray!")
                        return
                    }
